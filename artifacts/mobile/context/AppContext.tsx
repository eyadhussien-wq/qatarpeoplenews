...
export const DEFAULT_RADIO: RadioStation[] = [
  { id: '1', name: 'إذاعة القرآن الكريم (الدوحة)', url: 'https://stream.qbs.qa/quran/live/playlist.m3u8', color: '#1A4B38' },
  { id: '2', name: 'إذاعة قطر - البرنامج العام', url: 'https://stream.qbs.qa/qatarradio/live/playlist.m3u8', color: '#1A3A6B' },
  { id: '3', name: 'صوت الخليج', url: 'https://stream.soutalkhaleej.fm/live', color: '#6B1A4B' },
  { id: '4', name: 'راديو الريان', url: 'https://stream.alrayyan.tv/radio/live/playlist.m3u8', color: '#8A1538' },
];
