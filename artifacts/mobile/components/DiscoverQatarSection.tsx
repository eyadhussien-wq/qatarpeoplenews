...
const places = [
  { id: 'souq-waqif', title: 'سوق واقف', subtitle: 'سوق ثقافي وتراثي', url: `${VISIT_QATAR}/things-to-do/arts-culture/souq-waqif`, image: 'https://images.unsplash.com/photo-1584551246679-0daf3d275d0f?w=900&q=85' },
  { id: 'katara', title: 'حي كتارا الثقافي', subtitle: 'فنون وشاطئ', url: `${VISIT_QATAR}/things-to-do/arts-culture/katara-cultural-village`, image: 'https://images.unsplash.com/photo-1539650116574-75c0c6d73f6e?w=900&q=85' },
  { id: 'msheireb', title: 'مشيرب قلب الدوحة', subtitle: 'تراث مستدام وعصري', url: `${VISIT_QATAR}/places-to-visit/msheireb-downtown-doha`, image: 'https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?w=900&q=85' },
  { id: 'pearl', title: 'جزيرة اللؤلؤة', subtitle: 'مرسى وتسوق فاخر', url: `${VISIT_QATAR}/places-to-visit/the-pearl-qatar`, image: 'https://images.unsplash.com/photo-1569263979104-865ab7cd8d13?w=900&q=85' },
  { id: 'old-port', title: 'ميناء الدوحة القديم', subtitle: 'ممشى وإطلالات بحرية', url: `${VISIT_QATAR}/places-to-visit/old-doha-port`, image: 'https://images.unsplash.com/photo-1539650116574-75c0c6d73f6e?w=900&q=85' },
];
...
const styles = StyleSheet.create({
  ...
  card: { width: 160, height: 200, borderRadius: 16, overflow: 'hidden', backgroundColor: '#4A0E17', elevation: 4 },
